  ...
  function App() {
    ...
    (0, import_react12.useEffect)(() => {
      const fetchData = () => __async(this, null, function* () {
        var _a;
        try {
          const productId = (_a = data == null ? void 0 : data.product) == null ? void 0 : _a.id;
          console.log("Product ID from data:", productId);
          if (productId) {
            setProductID(productId);
            yield createOrFetchMetaobject(productId);
          } else {
    ...
    const createOrFetchMetaobject = (productId) => __async(this, null, function* () {
      try {
        let response = yield fetch("/admin/api/2024-04/metaobjects.json", {
          method: "GET",
          headers: {
            "Content-Type": "application/json"
          }
        });
        const metaobjects = yield response.json();
        console.log("Metaobjects fetched:", metaobjects);
        ...
        if (existingMetaobject) {
          ...
          response = yield fetch("/admin/api/2024-04/metaobjects.json", {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
          ...
          const newMetaobject = yield response.json();
    ...
    const updateMetaobjectField = (key, value) => __async(this, null, function* () {
      try {
        if (!metaobjectID) {
          console.error("Metaobject ID is not available");
          return;
        }
        yield fetch(`/admin/api/2024-04/metaobjects/${metaobjectID}.json`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json"
          },
